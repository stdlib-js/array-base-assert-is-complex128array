...
```javascript
isComplex128Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-assert-is-complex128array@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-assert-is-complex128array/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-assert-is-complex128array/actions/workflows/test.yml?query=branch:v0.2.3
